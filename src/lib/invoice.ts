...
//
// قواعد صدور (گیت):
//   فقط سفارش‌هایی که به «انبار و لجستیک» یا بعدتر رسیده‌اند فاکتور
//   می‌گیرند (lib/order-flow → INVOICE_ELIGIBLE_STATUSES).
//   هر سفارش حداکثر یک فاکتور نهایی دارد (orderId یکتا → 409).
//
// source:
