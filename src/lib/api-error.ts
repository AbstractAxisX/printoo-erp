...
//
// خطاهای Prisma دو خانوادهٔ پنهان دارند که برای کاربر نهایی «500 خاموش»
// هستند، در حالی که علتشان مشخص و قابل رفع است:
//
//  1) PrismaClientValidationError («Unknown field/model …») — کلاینتِ
...
//  2) P2021/P2022 — جدول/ستون در دیتابیس محلی وجود ندارد. همان رمدی.
//
