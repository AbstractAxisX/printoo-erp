 ...
 *     (خواستهٔ 1 کاربر: «اگر سفارش مجزا بود به ازای هر ایتم جدا پیش فاکتور ثبت شه»)
 *   • چند-مشتری + گروهی → سفارش گروهیِ هر مشتری جدا می‌شود و «هر آیتم»
 *     داخلش پیش‌فاکتور خودش را می‌گیرد (خواستهٔ 2: تفکیک مشتری + per-item)
 *   • گروهیِ تک-مشتری → یک پیش‌فاکتور برای کل گروه (خواستهٔ 3: زمان‌بندی
